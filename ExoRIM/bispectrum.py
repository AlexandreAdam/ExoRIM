...
class Baselines:
    # Actually --> should use this class since KPI looses track of sign when it chooses its baseline!
    # this is bas since closure relation is not satisfied
    def __init__(self, mask_coordinates):
...
def phase_closure_operator(kpi, i=0):
    """
...
# def eigenvector_phase_closure_operator(kpi):
